"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{19009:function(e,t,r){r.d(t,{Bt:function(){return sb},IO:function(){return ss},JU:function(){return iO},PL:function(){return sE},QT:function(){return sv},Xo:function(){return su},ad:function(){return iF},hJ:function(){return iV},oe:function(){return sI},pl:function(){return sT},qs:function(){return sD}});var n,i,s,a,o=r(95723),l=r(95893),u=r(9858),h=r(38954),c=r(41197),d=r(49079);let f="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tC{constructor(){this._=void 0}}function tA(e,t){return e instanceof tR?eV(t)||t&&"doubleValue"in t?t:{integerValue:0}:null}class tb extends tC{}class tD extends tC{constructor(e){super(),this.elements=e}}function tN(e,t){let r=tV(t);for(let t of e.elements)r.some(e=>eD(e,t))||r.push(t);return{arrayValue:{values:r}}}class tk extends tC{constructor(e){super(),this.elements=e}}function tx(e,t){let r=tV(t);for(let t of e.elements)r=r.filter(e=>!eD(e,t));return{arrayValue:{values:r}}}class tR extends tC{constructor(e,t){super(),this.serializer=e,this.Ie=t}}function tL(e){return ev(e.integerValue||e.doubleValue)}function tV(e){return eO(e)&&e.arrayValue.values?e.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sm(e,t,r){return e?r&&(r.merge||r.mergeFields)?e.toFirestore(t,r):e.toFirestore(t):t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sv(e){e=iD(e,iR);let t=iD(e.firestore,iP);return(function(e,t,r={}){let n=new C;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new ip({next:s=>{t.enqueueAndForget(()=>n$(e,a));let o=s.docs.has(r);!o&&s.fromCache?i.reject(new S(I.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&n&&"server"===n.source?i.reject(new S(I.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new nG(new tt(r.path),s,{includeMetadataChanges:!0,ta:!0});return nB(e,a)})(await iE(e),e.asyncQueue,t,r,n)),n.promise})(iU(t),e._key).then(r=>(function(e,t,r){let n=r.docs.get(t._key),i=new s_(e);return new sg(e,i,t._key,n,new sp(r.hasPendingWrites,r.fromCache),t.converter)})(t,e,r))}class s_ extends sf{constructor(e){super(),this.firestore=e}convertBytes(e){return new iB(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iR(this.firestore,null,t)}}function sE(e){e=iD(e,ix);let t=iD(e.firestore,iP),r=iU(t),n=new s_(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sC{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=iJ(e)}set(e,t,r){this._verifyNotCommitted();let n=sA(e,this._firestore),i=sm(n.converter,t,r),s=iX(this._dataReader,"WriteBatch.set",n._key,i,null!==n.converter,r);return this._mutations.push(s.toMutation(n._key,tP.none())),this}update(e,t,r,...n){let i;this._verifyNotCommitted();let s=sA(e,this._firestore);return i="string"==typeof(t=(0,h.m9)(t))||t instanceof i$?function(e,t,r,n,i,s){let a=e.Cu(1,t,r),o=[i3(t,n,r)],l=[i];if(s.length%2!=0)throw new S(I.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i3(t,s[e])),l.push(s[e+1]);let u=[],c=eB.empty();for(let e=o.length-1;e>=0;--e)if(!i7(u,o[e])){let t=o[e],r=l[e];r=(0,h.m9)(r);let n=a.yu(t);if(r instanceof iZ)u.push(t);else{let e=i1(r,n);null!=e&&(u.push(t),c.set(t,e))}}return new ij(c,new em(u),a.fieldTransforms)}(this._dataReader,"WriteBatch.update",s._key,t,r,n):function(e,t,r,n){let i=e.Cu(1,t,r);i9("Data must be an object, but it was:",i,n);let s=[],a=eB.empty();return eo(n,(e,n)=>{let o=i5(t,e,r);n=(0,h.m9)(n);let l=i.yu(o);if(n instanceof iZ)s.push(o);else{let e=i1(n,l);null!=e&&(s.push(o),a.set(o,e))}}),new ij(a,new em(s),i.fieldTransforms)}(this._dataReader,"WriteBatch.update",s._key,t),this._mutations.push(i.toMutation(s._key,tP.exists(!0))),this}delete(e){this._verifyNotCommitted();let t=sA(e,this._firestore);return this._mutations=this._mutations.concat(new tW(t._key,tP.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new S(I.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function sA(e,t){if((e=(0,h.m9)(e)).firestore!==t)throw new S(I.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}function sb(){return new i0("serverTimestamp")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
